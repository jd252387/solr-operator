...
```bash
helm install example apache-solr/solr --version 0.9.1 --set image.tag=8.8
```
...
```bash
helm upgrade example apache-solr/solr --version 0.9.1 --reuse-values --set image.tag=8.11
```
